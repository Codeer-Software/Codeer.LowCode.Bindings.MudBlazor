...
namespace SeleniumTest.PageObject
{
    public class ReadTileListDataSearchLayout : ComponentBase
    {
        ...
        public MudBooleanFieldSearchDriver List_Check => ByCssSelector("div[data-name='List.Check']").Wait();
        public LabelFieldSearchDriver ListToggleLabel => ByCssSelector("div[data-name='ListToggleLabel']").Wait();
        public MudBooleanFieldSearchDriver List_Toggle => ByCssSelector("div[data-name='List.Toggle']").Wait();
        public LabelFieldSearchDriver ListSwitchLabel => ByCssSelector("div[data-name='ListSwitchLabel']").Wait();
        public MudBooleanFieldSearchDriver List_Switch => ByCssSelector("div[data-name='List.Switch']").Wait();
        ...
        public MudRadioGroupFieldSearchDriver List_RadioGroup => ByCssSelector("div[data-name='List.RadioGroup']").Wait();
        public LabelFieldSearchDriver ListSelectLabel => ByCssSelector("div[data-name='ListSelectLabel']").Wait();
        public MudSelectFieldSearchDriver List_Select => ByCssSelector("div[data-name='List.Select']").Wait();
        public LabelFieldSearchDriver ListTextLabel => ByCssSelector("div[data-name='ListTextLabel']").Wait();
        public MudTextFieldSearchDriver List_Text => ByCssSelector("div[data-name='List.Text']").Wait();
        ...
        public MudFileFieldSearchDriver List_File => ByCssSelector("div[data-name='List.File']").Wait();
